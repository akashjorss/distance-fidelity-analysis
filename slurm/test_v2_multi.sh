#!/bin/bash
#SBATCH --job-name=v2_multi
#SBATCH --output=/gpfs/workdir/malhotraa/ConMax3D_reproduce/logs/v2m_%A_%a.out
#SBATCH --error=/gpfs/workdir/malhotraa/ConMax3D_reproduce/logs/v2m_%A_%a.err
...
RESULTS=$WORKDIR/ConMax3D_reproduce/results/v2_multi
...
K=10
STRATEGIES="concept_filtered_fvs,product_score,pure_fvs"

echo "=== Scene: $SCENE | Strategies: $STRATEGIES ==="
...
# ── Phase 1: Frame selection — all strategies (seva env) ──
echo "=== Phase 1: ConMax3D v2 multi-strategy frame selection ==="
...
# ── Phase 2: gsplat training for each strategy (gsplat_env) ──
