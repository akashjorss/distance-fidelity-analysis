...
METHODS = {
    ...
    'angular':    ('v3_nerf_fvs_angular',    'fvs_angular',    'v3_fvs_angular',    'fvs_angular'),
    'euclidean':  ('v3_nerf_fvs_euclidean',  'fvs_euclidean',  'v3_fvs_euclidean',  'fvs_euclidean'),
    'lpips_fvs':  ('v3_nerf_lpips_fvs',      'lpips_fvs',      'v3_lpips',          'lpips_fvs'),
}
